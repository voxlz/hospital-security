...
public class WriterReader {
	...
	/*
	 * Takes a fileName and a Journal and calls write() Throws something if
	...
	/*
	 * Takes a fileName and a User and calls write() Throws something if something
	 * going wrong
	 */
	...
	/*
	 * Returns a list of all the Journals that are in fileName program crashes if
	 * fileName has wrong format Throws file not found exception when file is not
	 * found
	 */
	...
	/*
	 * Returns a list of all the users that are in fileName program crashes if
	 * fileName has worng format Throws file not found exception when file is not
	 * found
	 */
	...
	/*
	 * Converts String to enum Should have used built in function, ops
	 */
